	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Osf2fV1alpha1().Storages(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Osf2fV1alpha1().Storages(namespace).Watch(context.TODO(), options)
			},
		},
		&osf2fmydomainv1alpha1.Storage{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *storageInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&osf2fmydomainv1alpha1.Storage{}, f.defaultInformer)
}
