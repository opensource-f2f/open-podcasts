	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Osf2fV1alpha1().Categories(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Osf2fV1alpha1().Categories(namespace).Watch(context.TODO(), options)
			},
		},
		&osf2fmydomainv1alpha1.Category{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *categoryInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&osf2fmydomainv1alpha1.Category{}, f.defaultInformer)
}
