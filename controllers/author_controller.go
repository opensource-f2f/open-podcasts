...
//+kubebuilder:rbac:groups=osf2f.my.domain,resources=authors,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=osf2f.my.domain,resources=authors/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=osf2f.my.domain,resources=authors/finalizers,verbs=update
